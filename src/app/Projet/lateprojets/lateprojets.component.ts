...
@Component({
  selector: 'app-lateprojets',
  templateUrl: './lateprojets.component.html',
  styleUrls: ['./lateprojets.component.scss']
})
export class LateprojetsComponent implements OnInit {
  ...
  constructor(public authService: AuthentificationService,public  dialog : MatDialog, public  router: Router,
